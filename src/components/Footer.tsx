      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-200 hover:text-naija-gold">FAQs</a></li>
              <li><a href="#" className="text-gray-200 hover:text-naija-gold">Contact Us</a></li>
              <li><a href="#" className="text-gray-200 hover:text-naija-gold">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-200 hover:text-naija-gold">Terms of Service</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold mb-4">Subscribe</h4>
            <p className="text-gray-200 mb-4">Stay updated with the latest events and opportunities</p>
